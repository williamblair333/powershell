...
function Check-Connectivity {
    ...
    if ($IncludeAADSecurityGroups) {
        ...
        if (!(Get-Module AzureAD -ListAvailable -Verbose:$false | ? {($_.Version.Major -eq 2 -and $_.Version.Build -eq 2 -and $_.Version.Revision -gt 3) -or ($_.Version.Major -eq 2 -and $_.Version.Build -eq 1)})) { Write-Host -BackgroundColor Red "This script requires a recent version of the AzureAD PowerShell module. Download it here: https://www.powershellgallery.com/packages/AzureAD/"; return}
...
if (($PSBoundParameters | measure).count) { Remove-UserFromAllGroups @PSBoundParameters }
